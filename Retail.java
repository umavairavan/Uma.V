...
Scanner sc=new Scanner(System.in);
   ...
   {
    case 1:
    System.out.println("Enter your bill for the day: ");
    float bill_e=sc.nextFloat();
    System.out.println("Did you brought Groceries  yes/no :");
    String k=sc.next();
    double bill1_e=bill_e;
    if(k.equals("yes"))
    {
     bill1_e=(bill_e*0.7);
    }
